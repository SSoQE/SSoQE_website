...
::: callout-important
**Currently, applications are open for students from Charles University or University of Bayreuth. Please wait until the application period for students from other universities opens.**
:::
...
**<!--- 1) --->SIS Course Registration**
  ...
  * The best route is via the SIS course [MB120C28: Science School on Quantitative  Ecology](https://is.cuni.cz/studium/predmety/index.php?do=predmet&kod=MB120C28).
  
<!---
  * ‼️**Please note that all slots in SIS are currently filled** - but don't worry! You can still register and be placed on the waiting list. If want to do so, please send email to ssoqe@natur.cuni.cz (with your name in the subject).
...
Curently, we are accepting applications only from students of Charles University and University of Bayreuth.

We will open applications for students from other universities later (March?) in 2026.
