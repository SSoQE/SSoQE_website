...
Some of the participants might have encountered the error of RStudio now being able to detech GIT branch. We have figure out the issue and can be fixed by [following the steps here](https://github.com/orgs/SSoQE/discussions/10)
